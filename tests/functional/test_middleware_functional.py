...
class TestClientIdMiddlewareFunctional:
    ...
    async def test_middleware_blocks_request_without_client_id(self, client: AsyncClient):
    ...
    async def test_middleware_allows_excluded_paths(self, client: AsyncClient):
        ...
        async with AsyncClient(app=app, base_url="http://test") as test_client:
            ...
            for path in excluded_paths:
                ...
                assert response.status_code not in [401, 403], f"Path {path} blocked by client id middleware"
