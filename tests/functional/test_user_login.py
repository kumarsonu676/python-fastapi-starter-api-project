...
class TestUserAuthentication:
    ...
    async def test_login_success(self, client: AsyncClient, created_user: User, test_user_data):
    ...
    async def test_login_invalid_password(self, client: AsyncClient, created_user: User):
