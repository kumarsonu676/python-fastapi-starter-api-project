...
class TestUserRepository:
    ...
    async def test_create_user(self, user_repository: UserRepository, test_user_data: dict):
    ...
    async def test_get_user_by_id(self, user_repository: UserRepository, created_user: User):
    ...
    async def test_get_user_by_email(self, user_repository: UserRepository, created_user: User):
    ...
    async def test_get_user_by_email_case_insensitive(self, user_repository: UserRepository, created_user: User):
    ...
    async def test_update_user(self, user_repository: UserRepository, created_user: User, db_session: AsyncSession):
    ...
    async def test_delete_user(self, user_repository: UserRepository, created_user: User, db_session: AsyncSession):
